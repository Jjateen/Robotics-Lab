# This Python progtam aims at implementing a controller based on the Actor-Critic (A2C) Approach to solve the CartPole Problem
...
while not solved and episodeCount < episodeLimit:
    ...
    for step in range(env.stepsPerEpisode):
        ...
        agent.update_network(observation,selectedAction,reward,newObservation)
